...
(
	...
	JRUBY_SNAPSHOT_XML=$(curl https://central.sonatype.com/repository/maven-snapshots/org/jruby/jruby-dist/${JRUBY_SNAPSHOT_VERSION}/maven-metadata.xml)
	...
	echo https://central.sonatype.com/repository/maven-snapshots/org/jruby/jruby-dist/${JRUBY_SNAPSHOT_VERSION}/jruby-dist-${JRUBY_SNAPSHOT_FULLVERSION}-bin.tar.gz
	SHA="$(curl -fSL https://central.sonatype.com/repository/maven-snapshots/org/jruby/jruby-dist/${JRUBY_SNAPSHOT_VERSION}/jruby-dist-${JRUBY_SNAPSHOT_FULLVERSION}-bin.tar.gz | sha256sum | awk '{print $1}')"
